...
\begin{titlepage}
    ...
    {\large Mind the Product -- World Product Day 2026\par}
    \vspace{0.3cm}
    {\large June 2026\par}
    ...
    \vspace{0.3cm}
    Erfan Mirzaee \quad $\bullet$ \quad Elijah Rodriguez \quad $\bullet$ \quad Esmeralda Amado
...
PRD Autopilot is an AI-powered founder platform that helps users validate ideas, generate Product Requirements Documents (PRDs), analyze product quality, create investor-ready pitch decks, and collaborate with AI throughout the product development process.
...
Many founders, students, product managers, and startup teams have strong ideas but struggle to turn them into structured product plans. Researching competitors, validating markets, writing PRDs, and creating pitch decks can take days or weeks.
...
PRD Autopilot was built using Next.js, TypeScript, Tailwind CSS, Supabase, Groq, Vercel, Novus Analytics, and the Notion API.
...
\begin{itemize}
    ...
    \item \textbf{Demo Video:} \href{https://youtu.be/I_RGj-ewkVc}{https://youtu.be/I_RGj-ewkVc}
\end{itemize}
...
\hline
Erfan Mirzaee & Backend, AI systems, architecture, deployment \\
\hline
Elijah Rodriguez & Frontend, dashboard, UI/UX, mobile polish \\
\hline
Esmeralda Amado & Authentication, QA testing, demo video, Devpost submission \\
\hline
\end{tabular}
\end{center}
